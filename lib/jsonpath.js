...
function JSONPath (obj, expr, arg) {
    if (!(this instanceof JSONPath)) { // Make "new" optional
        return new JSONPath(obj, expr, arg);
    }
    this.obj = obj;
    var self = this;
    var resultType = (arg && arg.resultType).toLowerCase() || 'value';
    var flatten = (arg && arg.flatten) || false;
    var wrap = (arg && arg.hasOwnProperty('wrap')) ? arg.wrap : true;
    this.sandbox = (arg && arg.sandbox) ? arg.sandbox : {};
