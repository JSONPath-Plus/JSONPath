(function (global, factory) {
	 ...
	 * @param {unknown} b
	 */
	const hasConstructor = (a, b) => {
	  return Function.prototype.toString.call(Object.getPrototypeOf(a).constructor) === Function.prototype.toString.call(b);
	};
	const structuredCloningCustomTypes = {
	  /**
	   * @param {unknown} val
	   */
	  NaN(val) {
	   ...
	   */
	  BigIntObject(val) {
	    return Boolean(val) && typeof val === 'object' && toStringTag(Object.getPrototypeOf(val)) === 'BigInt';
	  },
	  /**
	   * @param {unknown} val
	   */
	  ...
	  Blob(val, _path, _parent, _parentPropName, arg) {
	    return toStringTag(val) === 'Blob' && (!arg || arg === /** @type {Blob} */val.type);
	  },
	  /**
	   * @param {unknown} val
	   */
	  ...
	  File(val, _path, _parent, _parentPropName, arg) {
	    return toStringTag(val) === 'File' && (!arg || arg === /** @type {File} */val.type);
	  },
	  /**
	   * @param {unknown} val
	   */
	...
	class JSONPathClass {
	  ...
	  evaluate(expr, json, callback, otherTypeCallback) {
	    ...
	    this.currCustomTypes = this.customTypes === 'structuredCloning' ? structuredCloningCustomTypes : this.customTypes;
	    if (expr && typeof expr === 'object' && !Array.isArray(expr)) {
	      ...
	      this.currCustomTypes = Object.hasOwn(exprObj, 'customTypes') ? exprObj.customTypes === 'structuredCloning' ? structuredCloningCustomTypes : exprObj.customTypes : this.currCustomTypes;
